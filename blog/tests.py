...
class TestView(TestCase):
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.comment_001.auther.username, comment_001_area.text)
    ...
    def test_create_post(self):
        ...
        self.assertEqual(last_post.auther.username, 'obama')
    ...
    def test_update_post(self):
        ...
        # 로그인은 했지만 작성자가 아닌 경우
        self.assertNotEqual(self.post_003.auther, self.user_trump)
        self.client.login(
        ...
        # 작성자(obama)가 접근하는 경우
        self.client.login(
            username = self.post_003.auther.username,
            password = 'somepassword'
        )
        response = self.client.get(update_post_url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_comment(self):
        ...
        self.assertEqual(comment_002_delete_model_btn.attrs['data-target'],
    ...
    def test_search(self):
        self.post_about_python = Post.objects.create(
